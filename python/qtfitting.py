...
def qt_doublegauss(x,y0,A1,x01,w1,A2,x02,w2):
    """
    ...
    out = y0 + qt_gauss(x,A1,x01,w1) + qt_gauss(x,A2,x02,w2)
    return out
...
def qt_fit_function(params, x, y, function):
    """
